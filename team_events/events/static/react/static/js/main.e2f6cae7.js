/*! For license information please see main.e2f6cae7.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, n, t) => {
        ...
        function Pu(e, n, t, r, l) {
          ...
          if ((za(n, l), null === n.stateNode))
            ...
            u !== f || d !== m || zl.current || Ma
              ? ("function" === typeof p &&
                  (ru(n, t, p, r), (m = n.memoizedState)),
                (s = Ma || au(n, t, s, r, d, m, i) || !1)
                  ? (c ||
        ...
        function ls(e, n) {
          ...
          if (0 !== n) {
            if (
              ...
              throw ((t = Mi), ds(e, 0), us(e, r), rs(e, Ge()), t);
            if (6 === n) us(e, r);
            else {
              if (
  ...
  (t.m = e),
    ...
    (t.u = (e) => "static/js/" + e + ".e9bd7cc1.chunk.js"),
    (t.miniCssF = (e) => {}),
  ...
  const u = (e) => {
    ...
    function a() {
      ...
      for (let n of e) {
        ...
        if ("csrftoken" === e) return t;
      }
      return "";
    }
    (0, r.useEffect)(() => {
      fetch("/api/counter/".concat(n, "/"))
        .then((e) => e.json())
        .then((e) => l(e.value))
        .catch((e) =>
    ...
    return (0, o.jsxs)("div", {
      children: [
        ...
        (0, o.jsx)("button", {
          onClick: () => {
            fetch("/api/counter/".concat(n, "/increment/"), {
              method: "POST",
              mode: "same-origin",
              credentials: "include",
              headers: {
...
//# sourceMappingURL=main.e2f6cae7.js.map
