/*! For license information please see main.0632d130.js.LICENSE.txt */
(() => {
  var e = {
      3803: (e, t, n) => {
        'use strict';
...
`),
      ...
      function Ii() {
        const [t, n] = e.useState(null),
          ...
          { fetchWithTokens: a } = f(),
          [i, l] = e.useState(''),
          { setUserToken: u, setLoggedIn: c } = d();
        e.useEffect(() => {
          (async () => {
            try {
        ...
        const p = Boolean(t),
          ...
          b = (0, s.jsxs)(Ti, {
            ...
            onClose: g,
            children: [
              (0, s.jsx)(Ko, { onClick: g, children: 'My Events' }),
              (0, s.jsx)(Ko, {
                onClick: async () => {
                  try {
                    await a('api/logout/'), u(null), c(!1);
                  } catch (e) {
          ...
          x = 'primary-search-account-menu-mobile',
          w = (0, s.jsx)(Ti, {
            anchorEl: r,
            anchorOrigin: { vertical: 'top', horizontal: 'right' },
            id: x,
...
//# sourceMappingURL=main.0632d130.js.map
