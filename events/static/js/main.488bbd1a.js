/*! For license information please see main.488bbd1a.js.LICENSE.txt */
(() => {
  var e = {
      3803: (e, t, n) => {
        'use strict';
              ...
              case 0:
                switch (P) {
                  ...
                  default:
                    if (
                      (h(
                        (j = G($, t, n, m, v, o, d, T, (M = []), (L = []), g)),
                        i
                      ),
                      123 === P)
                    )
                      if (0 === v) K($, t, j, j, M, i, g, d, L);
                      else
  ...
  (n.m = e),
    ...
    (() => {
      ...
      function u() {
        const { csrfToken: t, userToken: n } = (function () {
        ...
        return {
          fetchWithTokens: async function (e) {
            let r =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : {};
      ...
      function ce(e) {
        ...
        async function pe(t, n, r) {
          ...
          if (r && r.pendingError)
            p = [_e(l).route.id, { type: k.error, error: r.pendingError }];
            ...
            let t = await (async function (e, t, n, r, o, a) {
              ...
              if (
                ...
                if ('error' === n.type) {
                  ...
                  return {
                    ...
                    pendingActionResult: [e, { type: k.error, error: r }],
                  };
                }
                if (!n.matches) {
                  let {
                  ...
                  return {
                    matches: e,
                    pendingActionResult: [r.id, { type: k.error, error: n }],
                  };
                }
                r = n.matches;
              }
              ...
              if ($e(i)) throw Le(400, { type: 'defer-action' });
              if (Fe(i)) {
          ...
          let {
            ...
            let k = () => S.forEach((e) => Ue(e.key));
            O && O.signal.addEventListener('abort', k);
            let { loaderResults: A, fetcherResults: E } = await Ce(
              _.matches,
              r,
              w,
              S,
            ...
            let { loaderData: R, errors: P } = Te(_, r, w, A, v, S, E, J);
            J.forEach((e, t) => {
              e.subscribe((n) => {
                (n || e.done) && J.delete(t);
              });
        ...
        async function be(e, t, n, r) {
          try {
            ...
            return n.map(() => ({ type: k.error, error: a }));
          }
        }
        ...
        return (
          (l = {
            ...
            enableScrollRestoration: function (e, t, n) {
              if (
                ((w = e), (A = t), (S = n || null), !P && _.navigation === oe)
              ) {
                P = !0;
              ...
              (L = !0 === (i && i.preventScrollReset)),
                g && He(g.formMethod)
                  ? (async function (t, n, r, o, i, l, s, d) {
                      ...
                      if ($e(x)) throw Le(400, { type: 'defer-action' });
                      let w = _.navigation.location || _.location,
                        S = Ee(e.history, w, h.signal),
                        k = a || u,
                        A =
                          'idle' !== _.navigation.state
                            ? C(k, _.navigation.location, c)
                            : _.matches;
                      v(A, "Didn't find any matches after fetcher action");
                      let E = ++H;
                      q.set(t, E);
                      let R = Ye(d, x.data);
                      _.fetchers.set(t, R);
                      ...
                      et(E),
                        'loading' === _.navigation.state && E > V
                          ...
                          : (ne({
                              errors: $,
                              loaderData: Me(_.loaderData, j, A, $),
                              fetchers: new Map(_.fetchers),
                            }),
                            (F = !1));
                  ...
                  : (G.set(t, { routeId: n, path: h }),
                    (async function (t, n, r, o, a, i, l, s) {
                      ...
                      v(!$e(h), 'Unhandled fetcher deferred data'),
                        Pe(t, Je(h.data));
                    })(t, n, h, b, f, p.active, l, g));
            },
            revalidate: function () {
                          ...
                          if (n.route.lazy)
                            if (a) {
                              ...
                              if (
                                ...
                                return { type: k.data, result: void 0 };
                              }
                              l = await u(a);
                            }
                          else {
      ...
      function Te(e, t, n, r, o, a, i, l) {
        ...
        for (let c = 0; c < a.length; c++) {
          ...
          if (!r || !r.signal.aborted)
            ...
            else if ($e(o)) v(!1, 'Unhandled fetcher deferred data');
            else {
              let n = Je(o.data);
              e.fetchers.set(t, n);
            }
      ...
      const En = (function () {
          ...
          createStyledComponent: (0, kn.Ay)('div', {
            name: 'MuiContainer',
            slot: 'Root',
            overridesResolver: (e, t) => {
              const { ownerState: n } = e;
          ...
          useThemeProps: (e) => (0, An.b)({ props: e, name: 'MuiContainer' }),
        }),
        Cn = En;
      var Rn = n(8698),
        Pn = n(2532);
      ...
      const Mn = [
        ...
        Ln = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiTypography' }),
            r = ((e) => Nn[e] || e)(n.color),
...
`)
        ...
        vr = (0, kn.Ay)('span', { name: 'MuiTouchRipple', slot: 'Root' })({
          overflow: 'hidden',
          pointerEvents: 'none',
          position: 'absolute',
          zIndex: 0,
        ...
        gr = (0, kn.Ay)(ar, { name: 'MuiTouchRipple', slot: 'Ripple' })(
          dr ||
            (dr = fr`
  opacity: 0;
  position: absolute;
...
`),
        ...
        yr = e.forwardRef(function (t, n) {
          const r = (0, An.b)({ props: t, name: 'MuiTouchRipple' }),
      ...
      const xr = (0, Pn.A)('MuiButtonBase', [
        ...
        kr = e.forwardRef(function (t, n) {
          const r = (0, An.b)({ props: t, name: 'MuiButtonBase' }),
            {
              action: o,
              centerRipple: a = !1,
              children: l,
      ...
      const Rr = e.createContext(void 0),
        ...
        Nr = e.forwardRef(function (t, n) {
          const r = e.useContext(Cr),
            o = e.useContext(Rr),
            a = (0, Qt.A)(r, t),
            l = (0, An.b)({ props: a, name: 'MuiButton' }),
            {
              children: s,
              color: u = 'primary',
              component: c = 'button',
          ...
          return (0, i.jsxs)(
            ...
            (0, Vt.A)(
              {
                ownerState: k,
                className: (0, qt.A)(r.className, A.root, d, R),
                component: c,
                disabled: f,
                focusRipple: !h,
                focusVisibleClassName: (0, qt.A)(A.focusVisible, v),
                ref: n,
                type: x,
              },
              S,
              { classes: A, children: [E, s, C] }
            )
          );
        }),
        Lr = () =>
      ...
      const Ur = ['className', 'component', 'elevation', 'square', 'variant'],
        ...
        Vr = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiPaper' }),
            {
              className: r,
              component: o = 'div',
              elevation: a = 1,
      ...
      const Kr = ['className', 'color', 'enableColorOnDark', 'position'],
        ...
        Qr = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiAppBar' }),
            {
              className: r,
              color: o = 'primary',
      ...
      const Jr = ['className', 'component', 'disableGutters', 'variant'],
        ...
        eo = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiToolbar' }),
            {
              className: r,
              component: o = 'div',
              disableGutters: a = !1,
      ...
      const no = (0, Pn.A)('MuiIconButton', [
        ...
        ao = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiIconButton' }),
            {
              edge: r = !1,
              children: o,
              className: a,
      ...
      const ko = function (e) {
        return (0, i.jsx)(
          wo,
          (0, Vt.A)({}, e, { defaultTheme: So.A, themeId: $n.A })
        );
      };
      function Ao(e) {
      ...
      function Eo(e) {
        ...
        return (
          e &&
          ((Ao(e.value) && '' !== e.value) ||
            (t && Ao(e.defaultValue) && '' !== e.defaultValue))
        );
      }
      function Co(e) {
      ...
      const Ro = (0, Pn.A)('MuiInputBase', [
        ...
        Lo = e.forwardRef(function (t, n) {
          var r;
          const o = (0, An.b)({ props: t, name: 'MuiInputBase' }),
            {
              'aria-describedby': a,
              autoComplete: l,
              autoFocus: s,
                  ...
                  (0, Vt.A)(
                    ...
                    D,
                    {
                      ...
                      children: [
                        ...
                        m,
                        N ? N((0, Vt.A)({}, X, { startAdornment: j })) : null,
                      ],
                    }
                  )
                ),
      ...
      const $o = (0, Pn.A)('MuiListItemIcon', ['root', 'alignItemsFlexStart']);
          ...
          return (0, Vt.A)(
            ...
            n.dense &&
              (0, Vt.A)(
                ...
                t.typography.body2,
                { [`& .${$o.root} svg`]: { fontSize: '1.25rem' } }
              )
          );
        }),
        Ho = e.forwardRef(function (t, n) {
          const r = (0, An.b)({ props: t, name: 'MuiMenuItem' }),
            {
              autoFocus: o = !1,
              component: a = 'li',
              dense: l = !1,
      ...
      const ta = [
        ...
        ra = e.forwardRef(function (t, n) {
          const r = (0, An.b)({ props: t, name: 'MuiList' }),
            {
              children: o,
              className: a,
              component: l = 'ul',
      ...
      const Ua = [
        ...
        Va = e.forwardRef(function (e, t) {
          var n, r, o;
          const a = (0, An.b)({ props: e, name: 'MuiBackdrop' }),
            {
              children: l,
              className: s,
              component: u = 'div',
      ...
      const ei = function (t) {
        ...
        const w = () => (
          ...
          E = (0, qa.A)((e) => {
            (h.current = e),
              e && (d && A() ? S() : m.current && Ga(m.current, x));
          }),
          C = e.useCallback(() => {
            a.remove(w(), x);
          }, [x, a]);
      ...
      const ni = [
        ...
        ai = e.forwardRef(function (t, n) {
          var r, o, a, l, s, u;
          const c = (0, An.b)({ name: 'MuiModal', props: t }),
            {
      ...
      const mi = (0, kn.Ay)(ii, {
        ...
        gi = e.forwardRef(function (t, n) {
          var r, o, a;
          const l = (0, An.b)({ props: t, name: 'MuiPopover' }),
            {
              action: s,
              anchorEl: u,
          ...
          const B = m || (u ? (0, Zo.A)(hi(u)).body : void 0),
            ...
            H = Jo({
              ...
              externalSlotProps: (0, Vt.A)({}, T, {
                style: j ? T.style : (0, Vt.A)({}, T.style, { opacity: 0 }),
              }),
      ...
      const bi = ['onEntering'],
        ...
        Ci = e.forwardRef(function (t, n) {
          var r, o;
          const a = (0, An.b)({ props: t, name: 'MuiMenu' }),
            {
              autoFocus: l = !0,
              children: s,
              className: u,
      ...
      function Ni() {
        ...
        e.useEffect(() => {
          (async () => {
            try {
              const e = await a('api/get-username/');
              s(e.username);
            } catch (e) {
        ...
        const c = Boolean(t),
          ...
          v = (0, i.jsxs)(Ci, {
            ...
            onClose: h,
            children: [
              (0, i.jsx)(Ho, { onClick: h, children: 'My Events' }),
              (0, i.jsx)(Ho, { onClick: h, children: 'Logout' }),
            ],
          }),
          g = 'primary-search-account-menu-mobile',
          y = (0, i.jsx)(Ci, {
            anchorEl: r,
            anchorOrigin: { vertical: 'top', horizontal: 'right' },
            id: g,
      ...
      const Ii = (0, Vt.A)(
        ...
        Di = e.forwardRef(function (e, t) {
          var n, r, o, a;
          const l = (0, An.b)({ props: e, name: 'MuiInput' }),
            {
              disableUnderline: s,
              components: u = {},
              componentsProps: c,
            ...
            w = null != (n = null != (r = m.root) ? r : u.Root) ? n : $i,
      ...
      const Ui = (0, Vt.A)(
        ...
        Ki = e.forwardRef(function (e, t) {
          var n, r, o, a;
          const l = (0, An.b)({ props: e, name: 'MuiFilledInput' }),
            {
              components: s = {},
              componentsProps: u,
              fullWidth: c = !1,
      ...
      const Qi = ['children', 'classes', 'className', 'label', 'notched'],
        Yi = (0, kn.Ay)('fieldset', { shouldForwardProp: Hn.A })({
          textAlign: 'left',
          position: 'absolute',
          bottom: 0,
          right: 0,
        ...
        Ji = (0, kn.Ay)('legend', { shouldForwardProp: Hn.A })((e) => {
      ...
      const el = (0, Vt.A)(
        ...
        al = e.forwardRef(function (t, n) {
          var r, o, a, l, s;
          const u = (0, An.b)({ props: t, name: 'MuiOutlinedInput' }),
            {
              components: c = {},
              fullWidth: d = !1,
              inputComponent: f = 'input',
            ...
            k = null != (r = null != (o = v.root) ? o : c.Root) ? r : nl,
            A = null != (a = null != (l = v.input) ? l : c.Input) ? a : ol;
          return (0, i.jsx)(
            zo,
            (0, Vt.A)(
              {
      ...
      const sl = (0, Pn.A)('MuiFormLabel', [
        ...
        fl = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiFormLabel' }),
      ...
      const hl = [
        ...
        vl = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ name: 'MuiInputLabel', props: e }),
      ...
      const bl = [
        ...
        wl = e.forwardRef(function (t, n) {
          const r = (0, An.b)({ props: t, name: 'MuiFormControl' }),
            {
              children: o,
              className: a,
              color: l = 'primary',
      ...
      const kl = (0, Pn.A)('MuiFormHelperText', [
        'root',
        'error',
        'disabled',
        'sizeSmall',
      ...
      const El = [
        ...
        Cl = (0, kn.Ay)('p', {
          ...
          return (0, Vt.A)(
            ...
            t.typography.caption,
            {
              ...
              [`&.${kl.error}`]: { color: (t.vars || t).palette.error.main },
            },
        ...
        Rl = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiFormHelperText' }),
      ...
      const Kl = e.forwardRef(function (t, n) {
        ...
        const {
          ...
          L = (0, Ht.A)(t, Bl),
          [z, I] = (0, jl.A)({ controlled: _, default: f, name: 'Select' }),
          [j, $] = (0, jl.A)({ controlled: R, default: d, name: 'Select' }),
          F = e.useRef(null),
          D = e.useRef(null),
          [B, W] = e.useState(null),
        ...
        const X = (e, t) => {
            e ? C && C(t) : A && A(t), U || (V(s ? null : G.clientWidth), $(e));
          },
      ...
      const Xl = (0, Gl.A)(
        ...
        ns = e.forwardRef(function (t, n) {
          const r = (0, An.b)({ name: 'MuiSelect', props: t }),
            {
              autoWidth: o = !1,
              children: a,
              classes: l = {},
                  ...
                  inputProps: (0, Vt.A)(
                    ...
                    b
                      ...
                      : {
                          ...
                          open: S,
                          renderValue: k,
                          SelectDisplayProps: (0, Vt.A)({ id: f }, A),
                        },
                    h,
      ...
      const as = [
        ...
        ss = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiTextField' }),
            {
              autoComplete: r,
              autoFocus: o = !1,
              children: a,
      ...
      const hs = (0, Pn.A)('MuiAlert', [
        ...
        Cs = e.forwardRef(function (e, t) {
          const n = (0, An.b)({ props: e, name: 'MuiAlert' }),
            {
              action: r,
              children: o,
              className: a,
          ...
          return (0, i.jsxs)(Wn, {
            ...
            children: [
              ...
              (0, i.jsx)('form', {
                onSubmit: async (e) => {
                  e.preventDefault();
                  c && ({ username: d, password: p }.email = m);
                  try {
                    const e = await w(r, {
                      method: s || 'POST',
                    ...
                    409 === t.status && x(a.BAD_REQUEST),
                      401 === t.status && x(a.UNAUTHORIZED),
                      404 === t.status && x(a.NOT_FOUND),
                      409 === t.status && x(a.USER_EXISTS),
                      500 === t.status && x(a.SERVER_ERROR),
                      y(null);
                  }
                },
        ...
        Os = (function (e, t) {
          ...
          { path: '/', element: (0, i.jsx)(c, { counterId: 1 }) },
          {
            ...
            element: (0, i.jsx)(Ms, {
              ...
              hasEmail: !0,
              successMessageText: (0, i.jsxs)('span', {
                children: [
                  'Success! Admin user created successfully. ',
                  (0, i.jsx)('a', { href: '/login', children: 'Go to Login' }),
                ],
              }),
            }),
          },
          ...
          },
          {
            ...
            element: (0, i.jsx)(Ms, {
              ...
              successMessageText: (0, i.jsxs)('span', {
                children: [
                  'Success! User created successfully. ',
                  (0, i.jsx)('a', { href: '/', children: 'Go to Home' }),
                ],
              }),
            }),
          },
...
//# sourceMappingURL=main.488bbd1a.js.map
